...
<div>
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <div>
            <h1 class="text-4xl font-light text-slate-800 tracking-tight">Kategori <span class="font-bold">Menu</span></h1>
            <p class="text-slate-500 mt-2">Kelola kategori produk untuk mengorganisir menu Anda.</p>
        </div>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50/50 transition-colors">
                    <td class="px-6 py-4">
                        <div class="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center text-xl">
                            {{ $category->icon ?? '📁' }}
                        </div>
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4">
                        <span class="text-slate-600">{{ $category->products_count ?? 0 }} produk</span>
                    </td>
                    <td class="px-6 py-4">
                ...
                <tr>
                    <td colspan="4" class="px-6 py-16">
                        <div class="text-center">
                            ...
                            <h3 class="text-lg font-semibold text-slate-800 mb-1">Belum Ada Kategori</h3>
                            <p class="text-slate-500 mb-6">Mulai dengan menambahkan kategori pertama untuk mengorganisir menu Anda.</p>
