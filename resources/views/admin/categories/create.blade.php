...
<div>
    ...
    <div class="mb-10">
        ...
        <h1 class="text-4xl font-light text-slate-800 tracking-tight">Tambah <span class="font-bold">Kategori</span></h1>
        <p class="text-slate-500 mt-2">Buat kategori baru untuk mengorganisir produk menu Anda.</p>
    </div>
