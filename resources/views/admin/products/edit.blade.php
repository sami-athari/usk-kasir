...
<div>
    ...
    <div class="mb-10">
        ...
        <h1 class="text-4xl font-light text-slate-800 tracking-tight">Edit <span class="font-bold">Menu</span></h1>
        <p class="text-slate-500 mt-2">Ubah data {{ $product->name }}</p>
    </div>
        ...
        <div class="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm">
            <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="w-32 h-32 rounded-2xl overflow-hidden bg-slate-50 border border-slate-200">
