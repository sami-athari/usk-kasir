...
<body class="bg-[#F8FAFC] text-slate-700 antialiased min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-slate-800 mt-6">Welcome Back!</h1>
            <p class="text-slate-500 mt-2">Login dulu biar bisa pesan kopi</p>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('password.request') }}" class="text-sm text-emerald-500 hover:text-emerald-600 font-medium">Lupa password?</a>
                    @endif
                </div>
            ...
            <p class="text-center text-slate-600">
                Belum punya akun?
                <a href="{{ route('register') }}" class="text-emerald-500 hover:text-emerald-600 font-semibold">Daftar yuk!</a>
            </p>
        </div>
